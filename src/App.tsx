    ...
    <Router>
      {showSplash ? (
        ...
        <div className="relative min-h-screen">
          {/* Fundo digital/tech escuro */}
          <div className="absolute inset-0 -z-10 w-full h-full bg-gradient-to-br from-[#f7931a] via-black to-black opacity-80 backdrop-blur-sm" />
                ...
                <div className="container mx-auto">
                  <div className="flex justify-between items-center">
                    ...
                    <ul className="hidden md:flex space-x-6">
                      ...
                      <li>
                        <Link to="/eventos" className="hover:text-white/80 flex flex-col items-center">
                          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                          </svg>
                          <span className="text-sm mt-1">Eventos</span>
                        </Link>
                      </li>
                      <li>
                        <Link to="/mapa" className="hover:text-white/80 flex flex-col items-center">
                          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A2 2 0 013 15.382V7.618a2 2 0 011.553-1.894l7-2.1a2 2 0 011.894 0l7 2.1A2 2 0 0121 7.618v7.764a2 2 0 01-1.553 1.894L15 20" />
                          </svg>
                          <span className="text-sm mt-1">Mapa Cripto</span>
                        </Link>
                      </li>
                      <li>
